...
public class NumAnimation extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_num_animation);
		...
		drawKanji.setBackgroundResource(R.drawable.numkanjione);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_num_animation, menu);
		return true;
	}
