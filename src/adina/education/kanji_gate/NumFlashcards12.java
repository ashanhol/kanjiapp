...
public class NumFlashcards12 extends Activity {
	ArrayList<View> arr= new ArrayList<View>();

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_num_flashcards12);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_num_flashcards12, menu);
		return true;
	}
	...
	public void prevPage(View v) {
		Intent intent= new Intent(this, NumFlashcards11.class);
