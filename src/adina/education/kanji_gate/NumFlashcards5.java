...
public class NumFlashcards5 extends Activity {
	ArrayList<View> arr= new ArrayList<View>();

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_num_flashcards5);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_num_flashcards5, menu);
		return true;
	}
	...
	public void prevPage(View v) {
		Intent intent= new Intent(this, NumFlashcards4.class);
		startActivity(intent);

	}
	public void nextPage(View v) {
		Intent intent= new Intent(this, NumFlashcards6.class);
		startActivity(intent);
