...
public class NumAnimation2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_num_animation2);
		...
		drawKanji.setBackgroundResource(R.drawable.numkanjithree);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_num_animation2, menu);
		return true;
	}
