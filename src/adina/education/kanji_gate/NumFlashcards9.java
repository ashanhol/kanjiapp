...
public class NumFlashcards9 extends Activity {
	ArrayList<View> arr= new ArrayList<View>();

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_num_flashcards9);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_num_flashcards9, menu);
		return true;
	}
	...
	public void prevPage(View v) {
		Intent intent= new Intent(this, NumFlashcards8.class);
