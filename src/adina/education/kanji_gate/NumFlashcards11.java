...
public class NumFlashcards11 extends Activity {
	ArrayList<View> arr= new ArrayList<View>();

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_num_flashcards11);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_num_flashcards11, menu);
		return true;
	}
	...
	public void prevPage(View v) {
		Intent intent= new Intent(this, NumFlashcards10.class);
		startActivity(intent);

	}
	public void nextPage(View v) {
		Intent intent= new Intent(this, NumFlashcards12.class);
		startActivity(intent);
